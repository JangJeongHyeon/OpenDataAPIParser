 ...
 */
public class PopulationAPI implements API {
    private  Map<String, Service> services = new ConcurrentHashMap<String, Service>();
    private  String DEFAULT_SERVICE_NAME = "<Not defined>";
    private HttpClient defaultClient = HttpClientBuilder.create().setConnectionTimeToLive(2L, TimeUnit.SECONDS).build();
